...
class BulkSalesPriceUpdate:
   ...
   def product_group(self,filename="CSV/product_groups.csv"):
   ...
   def select_category(self):
      ...
      group_name = self.product_group()
      main_group.select_option(label=group_name)
      print("mainGroup selected: ",group_name)
